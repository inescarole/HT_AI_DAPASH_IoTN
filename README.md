...
Full parameter tables are in `supplementary_parameters.texpdf`.

## Supplementary Material

`supplementary_parameters.pdf` contains tables covering all simulation parameters, patient physiological bounds, device criticality weights, particle filter settings, and meta-learner hyperparameters. 
